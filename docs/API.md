...
| propagationStyle | `DD_TRACE_PROPAGATION_STYLE`      | `datadog,traceparent` | The selection and priority order of context propagation injection and extraction mechanisms.
| propagationStyle.inject | `DD_TRACE_PROPAGATION_STYLE_INJECT` | `datadog,traceparent` | The selection of context propagation injection mechanisms.
| propagationStyle.extract | `DD_TRACE_PROPAGATION_STYLE_EXTRACT` | `datadog,traceparent` | The selection and priority order of context propagation extraction mechanisms.
